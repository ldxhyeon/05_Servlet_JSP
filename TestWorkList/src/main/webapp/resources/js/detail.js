...
// URLSerachParams : 쿼리스트링을 객체 형태로 다룰 수 있게 하는 객체
...
completeBtn.addEventListener("click", () => {
  ...
  location.href = "/work/complete?index=" + index;
});
...
deleteBtn.addEventListener("click", () => {
  ...
  location.href = "/work/delete?index=" + index;
});
...
updateBtn.addEventListener("click", () => {
  ...
  // GET 방식 요청
  location.href = "/work/update?index=" + index;
});
